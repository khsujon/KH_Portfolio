  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div className="mt-28 md:mt-5 lg:5 pointer-events-auto">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Kamrul</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
          I craft futuristic mobile apps using Flutter & Node.js,<br/>
          blending performance with modern design. 
          </p>
        </div>
      </div>
